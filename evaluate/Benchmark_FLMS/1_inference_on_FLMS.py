...
input_json_path = "Venus_CVPR2026/data/Benchmark_FLMS/json/image_crops.json"
img_folder = "Venus_CVPR2026/data/Benchmark_FLMS/images"
output_json_path = "Venus_CVPR2026/evaluate/Benchmark_FLMS/1_inference_on_FLMS.json"
...
for image_name in tqdm(data.keys(), desc="Processing Images", unit="image"):
    ...
    query = tokenizer.from_list_format([
        {'image': image_path},
        {'text': 'Please provide the bounding box coordinate of the most visually balanced and aesthetically pleasing composition area.'},
    ])
